  ...
  <div class="main_right">
	  ...
	  <div class="oe_tab_nv">
	    <ul>
		  ...
		  <li class="tab_item<!--{if $cp_menuid == 'money'}--> current<!--{/if}-->"><a href="<!--{$ucfile}-->?c=money">金币记录</a></li>
		  <li class="tab_item<!--{if $cp_menuid == 'points'}--> current<!--{/if}-->"><a href="<!--{$ucfile}-->?c=points">积分记录</a></li>
	    </ul>
	  </div>

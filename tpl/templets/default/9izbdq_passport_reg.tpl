        ...
        <div class="bitian">
          ...
          <div class="form_li">
            <div class="serve_text">
              ...
              <em>已阅读和同意 <a href="<!--{$urlpath}-->index.php?c=about&a=detail&id=8" target="_blank">注册条款</a> 和 <a href="<!--{$urlpath}-->index.php?c=about&a=detail&id=7" target="_blank">隐私政策</a></em>
            </div>
            <div class="tijiao"> 

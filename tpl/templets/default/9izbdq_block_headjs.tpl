...
<script type='text/javascript' src='<!--{$urlpath}-->tpl/static/js/ajax.extend.js'></script>
<script type="text/javascript" src='<!--{$urlpath}-->tpl/static/js/WdatePicker.js'></script>
<script type="text/javascript" src="<!--{$urlpath}-->tpl/static/js/jquery.slide.js"></script>
<script type="text/javascript" src="<!--{$urlpath}-->tpl/static/varpop/jquery.slideui.js"></script>
...
<script type="text/javascript" src="<!--{$skinpath}-->js/search.js"></script>
	    ...
	    <div class="oe_user_more_list">
		  ...
		  <dl>
			...
			<dd>
			  ...
			  <p class="p_1">
			    <!--{if $volist.gender=='1'}-->男<!--{else}-->女<!--{/if}-->，<!--{$volist.age}-->岁，<!--{$volist.height}-->CM，<!--{area type='text' value=$volist.provinceid}--><!--{area type='text' value=$volist.cityid}-->
			  </p>
              <p class="p_2">
                <!--{$volist.monolog|filterhtml:85}-->.. 
              </p>
			  <h3> 

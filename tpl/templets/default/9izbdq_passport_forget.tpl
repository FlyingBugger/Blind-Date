  ...
  <div class="ce_reg">
    ...
    <div class="left public_960box_m">
      ...
      <ul class="form_box left_form">
        <li class=" form_ml title">邮箱找回密码</li>
        ...
        <li class="form_li">
          <label>验证码：</label>
		  <input type="text" id="checkcode" name="checkcode" class='w2' autocomplete="off" style="width:80px;" /> <img id="checkCodeImg" src="<!--{$urlpath}-->source/include/imagecode.php?act=verifycode" align="middle" /> <a href="javascript:refreshCode();"> 换一张</a>

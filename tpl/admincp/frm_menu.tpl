...
<div id="accordion2">
  ...
  <ul class="switchable-panel" id='label_11'>
      <li>
          <a href="<!--{$cpfile}-->?c=party" target='main'>活动列表</a>&nbsp;
          <a href="<!--{$cpfile}-->?c=party&a=add" target='main'>发布活动</a>
      </li>
      <li>
          <a href="<!--{$cpfile}-->?c=partybm" target='main'>活动报名</a>&nbsp;
          <a href="<!--{$cpfile}-->?c=partybm&sflag=3" target='main'>待审核报名</a>
      </li>
      <li>
          <a href="<!--{$cpfile}-->?c=partybm&sflag=1" target='main'>成功报名</a>&nbsp;
          <a href="<!--{$cpfile}-->?c=partybm&sflag=2" target='main'>取消报名</a>
      </li>
  </ul>
  ...
  <ul class="switchable-panel" id='label_9' style="display:;">
    <li>
	  <a href="<!--{$cpfile}-->?c=case" target='main'>成功案例</a>  
	</li>
	<li>
	  <a href="<!--{$cpfile}-->?c=case&a=add" target='main'>添加成功案例</a>
	</li>
  </ul>
  ...
  <ul class="switchable-panel" id='label_10' style="display:;">
    <li>
	  <a href="<!--{$cpfile}-->?c=safety" target='main'>防骗文章</a>  
	</li>
	<li> 
	  <a href="<!--{$cpfile}-->?c=safety&a=add" target='main'>添加防骗文章</a>
	</li>
  </ul>
  <!--{/if}-->
  ...
  <ul class="switchable-panel" id='label_1'>
    ...
    <li>
      <a href='<!--{$cpfile}-->?c=setting&a=weixin' target='main'>微信H5支付</a>
    </li>
	<li>

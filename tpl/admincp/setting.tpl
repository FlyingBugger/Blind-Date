    ...
    <div class="set-area">
        <div class="form web-info-form">
            <div class="form-row">
                ...
                <div class="form-cont">
                    <input name="baidumap_key" id="baidumap_key" class="input-txt" type="text" value="<!--{$baidumap_key}-->" />
		...
		<div class="form-row">
          ...
          <div class="form-row">
              ...
              <div class="form-cont">
                  ...
                  <table border="0" cellspacing="0" cellpadding="0">
                      <tr>
                          <td><input type="text" name="mobileqr" id="mobileqr" value="<!--{$mobileqr}-->" class="input-txt" /> <span id='dmobileqr' class='f_red'></span></td>
                          <td>
                              <iframe id='iframe_t' border='0' frameborder='0' scrolling='no' style="width:260px;height:25px;padding:0px;margin:0px;" src='<!--{$cpfile}-->?c=upload&formname=myform&module=upload&uploadinput=mobileqr&multipart=sf_upload&previewid=mobileqr_previewsrc'></iframe>
                          </td>
                      </tr>
                  </table>
                  上传图片只支持：gif,jpeg,jpg,png格式
          ...
          <div class="form-row">
              ...
              <div class="form-cont">宽：<input name="mobileqrwidth" id="mobileqrwidth" type="text" size="5" value="<!--{$mobileqrwidth}-->" />px；高：<input name="mobileqrheight" id="mobileqrheight" type="text" size="5" value="<!--{$mobileqrheight}-->" />px</div>
          </div>
  ...
  <div class="main-cont">
	...
	<table cellpadding='2' cellspacing='2' class='tab'>
	  ...
	  <tr>
		...
		<td class="hback">每页显示 <input type="text" name="casepagesize" id="casepagesize" class="input-s" value="<!--{$config.casepagesize}-->" />条</td>
	  </tr>
	  <tr>
	    <td class='hback_1'>防骗文章分页：</td>
		<td class="hback">每页显示 <input type="text" name="safetypagesize" id="safetypagesize" class="input-s" value="<!--{$config.safetypagesize}-->" />条</td>
	  </tr>
    ...
    <div class="oe_apply">
      ...
      <div class="bd">
        ...
        <div class="resulted" style="display:none;" id="step_success_box">
          ...
          <form id="myform" action="<!--{$oefile}-->&c=<!--{$c}-->" method="post">
		...
		<td width="50%" valign="top">
		  ...
		  <table class="oe_table_wrap">
			...
			<tr id="but_app_data" style="display:none;">
			  <td>
			    <a href="<!--{$oefile}-->?c=setting&a=appcredit" class="oe_ico_orange">申请诚信联盟</a>
			  </td>
			</tr>
			<tr id="but_edit_data" style="display:none;">
			  <td>
			    <a href="<!--{$oefile}-->?c=setting&a=appcredit" class="oe_ico_green">重新编辑申请</a>
			  </td>
			</tr>
		  </table>
...
<!--{if $a eq "weixin"}-->
<div class="main-wrap">
    <div class="path"><p>当前位置：应用&插件<span>&gt;&gt;</span>微信H5支付<span>&gt;&gt;</span><a href="<!--{$cpfile}-->?c=setting&a=mail">微信支付设置</a></p></div>
    <div class="main-cont">
        ...
        <table cellpadding='2' cellspacing='1' class='tab'>
            <tr>
                ...
                <td class="hback" width="85%">
                    <label><input type="radio" name="weixin_h5pay" id="weixin_h5pay" value="1"<!--{if $config.weixin_h5pay == '1'}--> checked<!--{/if}--> />开启</label>&nbsp;&nbsp;
                    <label><input type="radio" name="weixin_h5pay" id="weixin_h5pay" value="0"<!--{if $config.weixin_h5pay == '0'}--> checked<!--{/if}--> />关闭</label>
            ...
            <tr>
                ...
                <td class="hback">
                    <input type="text" name="weixin_appid" id="weixin_appid" class="input-b" value="<!--{$config.weixin_appid}-->" />
                </td>
            </tr>
            <tr>
                <td class="hback_1">微信AppSecret： </td>
                <td class="hback">
                    <input type="text" name="weixin_key" id="weixin_key" class="input-b" value="<!--{$config.weixin_appkey}-->" />
                </td>
            </tr>
            <tr>
                <td class="hback_1">微信支付商户号： </td>
                <td class="hback">
                    <input type="text" name="weixin_mchid" id="weixin_mchid" class="input-b" value="<!--{$config.weixin_mchid}-->" />
                </td>
            </tr>
            <tr>
                <td class="hback_1">微信支付API KEY： </td>
                <td class="hback">
                    <input type="text" name="weixin_paykey" id="weixin_paykey" class="input-b" value="<!--{$config.weixin_paykey}-->" />
                </td>
            </tr>
            <tr>
                <td class="hback_1">微信支付费率：</td>
                <td class="hback">
                    <input type="text" name="weixin_payrate" id="weixin_payrate" class="input-s" value="<!--{$config.weixin_payrate}-->" />
                    % （不填写表示无费率）
                </td>
            </tr>
            <tr>

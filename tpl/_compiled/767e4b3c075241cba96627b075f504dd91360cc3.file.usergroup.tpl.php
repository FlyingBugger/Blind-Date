<?php /* Smarty version Smarty-3.1.14, created on 2017-12-12 13:17:59
         compiled from "D:\freehost\ftp122778453\web\tpl\admincp\usergroup.tpl" */ ?>
<?php /*%%SmartyHeaderCode:157395a2f6688001211-96178361%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '767e4b3c075241cba96627b075f504dd91360cc3' => 
    array (
      0 => 'D:\\freehost\\ftp122778453\\web\\tpl\\admincp\\usergroup.tpl',
      1 => 1465888390,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '157395a2f6688001211-96178361',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a2f6688b65fa8_68722903',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a2f6688b65fa8_68722903')) {function content_5a2f6688b65fa8_68722903($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
?>
	  ...
	  <tr>
		...
		<td colspan="7"><input class="button" name="btn_del" type="button" value="删 除" onclick="{if(confirm('确定删除选定信息吗!?')){$('#myform').submit();return true;}return false;}" class="button">&nbsp;&nbsp;共[ <b><?php echo $_smarty_tpl->tpl_vars['total']->value;?>
</b> ]条记录</td>
	  </tr>
	  <?php }?>
	</table>
...
" /> 条</td>
	  ...
	  <tr>
		...
		<td class='hback' colspan="3" style="line-height:30px;">
		每天发送信件数量 &nbsp;&nbsp;
		<input type='radio' name='daysendslimit' id='daysendslimit' value='0'<?php if ($_smarty_tpl->tpl_vars['usergroup']->value['msg']['daysendslimit']=='0'){?>  checked<?php }?> />不限，
		<input type='radio' name='daysendslimit' id='daysendslimit' value='1'<?php if ($_smarty_tpl->tpl_vars['usergroup']->value['msg']['daysendslimit']=='1'){?>  checked<?php }?> />限制 
		<input type="text" name="daysends" id="daysends" class="input-s" value="<?php echo $_smarty_tpl->tpl_vars['usergroup']->value['msg']['daysends'];?>
" /> 封 <font color="#999999">(限制请填写整数)</font><br />

		每天查看信件数量  &nbsp;&nbsp;
		<input type='radio' name='dayviewslimit' id='dayviewslimit' value='0'<?php if ($_smarty_tpl->tpl_vars['usergroup']->value['msg']['dayviewslimit']=='0'){?>  checked<?php }?> />不限，
		<input type='radio' name='dayviewslimit' id='dayviewslimit' value='1'<?php if ($_smarty_tpl->tpl_vars['usergroup']->value['msg']['dayviewslimit']=='1'){?>  checked<?php }?> />限制 
		<input type="text" name="dayviews" id="dayviews" class="input-s" value="<?php echo $_smarty_tpl->tpl_vars['usergroup']->value['msg']['dayviews'];?>
" /> 封 <font color="#999999">(限制请填写整数)</font><br />
	  ...
	  <tr>
		...
		<input type='checkbox' name='viewcredit' id='viewcredit' value='1'<?php if ($_smarty_tpl->tpl_vars['usergroup']->value['view']['viewcredit']=='1'){?> checked<?php }?> />诚信查询（查询某个会员的诚信情况）

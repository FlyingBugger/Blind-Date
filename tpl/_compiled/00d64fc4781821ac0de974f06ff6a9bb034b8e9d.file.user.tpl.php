<?php /* Smarty version Smarty-3.1.14, created on 2017-12-12 13:18:03
         compiled from "D:\freehost\ftp122778453\web\tpl\admincp\user.tpl" */ ?>
<?php /*%%SmartyHeaderCode:224245a2f668b835d27-50128144%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '00d64fc4781821ac0de974f06ff6a9bb034b8e9d' => 
    array (
      0 => 'D:\\freehost\\ftp122778453\\web\\tpl\\admincp\\user.tpl',
      1 => 1512634222,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '224245a2f668b835d27-50128144',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a2f668e9e5506_88431305',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a2f668e9e5506_88431305')) {function content_5a2f668e9e5506_88431305($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include 'D:\\freehost\\ftp122778453\\web\\source\\core\\smarty\\plugins\\modifier.date_format.php';
?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=<?php echo $_smarty_tpl->tpl_vars['page_charset']->value;?>
" />
<title>会员管理-<?php echo $_smarty_tpl->tpl_vars['copyright_header']->value;?>
</title>
...
');"><?php echo $_smarty_tpl->tpl_vars['volist']->value['username'];?>
		...
		<td title="注册时间：<?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['volist']->value['regtime'],"%Y/%m/%d %H:%M:%S");?>
">
...
')" />&nbsp;&nbsp;
            ...
            <input type='button' name='btn_credit' id='btn_credit' value='诚信查询' onclick="oelove_varpop_creditview('诚信查询', '<?php echo $_smarty_tpl->tpl_vars['user']->value['userid'];?>
')" />&nbsp;&nbsp;
            <?php }else{ ?>
            <input type='button' name='btn_credit' id='btn_credit' value='诚信查询' disabled />&nbsp;
            <?php }?>
			<a href="<?php echo $_smarty_tpl->tpl_vars['cpfile']->value;?>
		...
		<div id="myTab_Content0" class="">
			<table cellpadding='2' cellspacing='2' class='tab'>
			  ...
			  <tr>
				...
				<td class='hback' width='35%'>
				  <?php echo cmd_avatar(array('width'=>'30','height'=>'37','value'=>$_smarty_tpl->tpl_vars['user']->value['avatarurl']),$_smarty_tpl);?>
...
(<?php echo $_smarty_tpl->tpl_vars['user']->value['levelimg'];?>
				...
				<td class='hback_1' width='15%'>用 户 名 <span class='f_red'></span></td>
				<td class='hback' width='35%'>
				  <input type="text" name="username" id="username" class="input-100" value="<?php echo $_smarty_tpl->tpl_vars['user']->value['username'];?>
" />
			  ...
			  <tr>
				...
				<td class='hback'>
				  ...
				  <a href="javascript:;" class="oe_ico_blue" f="creditget" data-type="email" data-value="<?php echo $_smarty_tpl->tpl_vars['user']->value['email'];?>
...
" /> <span id='drealname' class='f_red'></span> <font color="#999999"> (不会公开，认证身份用) </font></td>
			  ...
			  <tr>
				<td class='hback_1'>身份证号码 <span class='f_red'></span></td>
				<td class='hback' colspan="3">
				  <input type="text" name="idnumber" id="idnumber" class="input-txt" value="<?php echo $_smarty_tpl->tpl_vars['user']->value['idnumber'];?>
" /> <span id='didnumber' class='f_red'></span> <font color="#999999"> (不会公开，认证身份用)  </font>
				
				 <a href="javascript:;" class="oe_ico_blue" f="creditget" data-type="idcard" data-value="<?php echo $_smarty_tpl->tpl_vars['user']->value['idnumber'];?>
...
" /> <span id='dzipcode' class='f_red'></span> <font color="#999999"> (不会公开，网站赠送礼品用) </font></td>
			  ...
			  <tr>
				<td class='hback_1'>手机号码 <span class='f_red'></span></td>
				<td class='hback' colspan="3">
				  <input type="text" name="mobile" id="mobile" class="input-100" value="<?php echo $_smarty_tpl->tpl_vars['user']->value['mobile'];?>
" /> <span id='dmobile' class='f_red'></span>

				  <a href="javascript:;" class="oe_ico_blue" f="creditget" data-type="mobile" data-value="<?php echo $_smarty_tpl->tpl_vars['user']->value['mobile'];?>
...
" /> <span id='dtelephone' class='f_red'></span></td>
			  ...
			  <tr>
				<td class='hback_1'>QQ号码 <span class='f_red'></span></td>
				<td class='hback' colspan="3">
				  <input type="text" name="qq" id="qq" class="input-100" value="<?php echo $_smarty_tpl->tpl_vars['user']->value['qq'];?>
" />
				  <span id='dqq' class='f_red'></span>

				  <a href="javascript:;" class="oe_ico_blue" f="creditget" data-type="qq" data-value="<?php echo $_smarty_tpl->tpl_vars['user']->value['qq'];?>
" data-tips="tips_qq">查询诚信</a> <span id="tips_qq"></span>
			  ...
			  <tr>
				<td class='hback_1'>微信 <span class='f_red'></span></td>
				<td class='hback' colspan="3">
				  <input type="text" name="msn" id="msn" class="input-txt" value="<?php echo $_smarty_tpl->tpl_vars['user']->value['msn'];?>
" />
				  <span id='dmsn' class='f_red'></span>

				  <a href="javascript:;" class="oe_ico_blue" f="creditget" data-type="weixin" data-value="<?php echo $_smarty_tpl->tpl_vars['user']->value['msn'];?>
...
?c=user",
			cache: false,
			data: {a:"checkeditname", username:$(this).val(), userid:"<?php echo $_smarty_tpl->tpl_vars['id']->value;?>
", r:get_rndnum(8)},
			dataType: "json",
